            ...
            @if ($isAboutPage)
                <div class="mx-auto max-w-6xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5 space-y-3">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                            ...
                            <div id="aboutEditor" contenteditable="true"
                                class="min-h-[420px] w-full rounded-lg border border-slate-200 bg-white p-4 text-slate-900 outline-none focus:border-sky-300 focus:ring-2 focus:ring-sky-100"></div>
                    ...
                    <button type="button" wire:click="saveAboutContent"
                        class="mt-5 rounded-xl bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-sky-700">
                        Save About Content
                    </button>
                </div>
            @else
                <div class="mx-auto max-w-6xl space-y-4">
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            <p class="mt-2 text-3xl font-bold text-slate-900">128</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            <p class="text-sm text-slate-500">Total Orders</p>
                            <p class="mt-2 text-3xl font-bold text-slate-900">62</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            <p class="text-sm text-slate-500">Pending Enquiries</p>
                            <p class="mt-2 text-3xl font-bold text-slate-900">14</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            <p class="text-sm text-slate-500">Active Users</p>
                            <p class="mt-2 text-3xl font-bold text-slate-900">49</p>
                        </div>
                    </div>

                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                        <h2 class="text-xl font-semibold text-slate-900">{{ $pageTitle }}</h2>
                        <p class="mt-2 text-slate-600">Is section ka detailed content aap yahan se manage kar sakte hain.</p>
                    </div>
                </div>
            @endif
        </section>
